...
This is a factory class to generate a new Error object. This will be used for
the Error builder in case we have multiple errors while performing data
ingestion (which is unlikely).
"""
