...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # we dont want to include is_admin because that would imply the user will be able to change those values from its request (when they create objects)
    ...
    def create(self, validated_data):
        ...
        # we instead will use the create_user after we validated the data above and that will encrypt the passowrd as we defined in the user manager
